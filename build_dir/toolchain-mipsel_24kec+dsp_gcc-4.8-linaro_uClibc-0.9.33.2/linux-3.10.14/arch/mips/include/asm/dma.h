...
#elif (defined (CONFIG_RALINK_MT7621) && (CONFIG_RALINK_RAM_SIZE == 256))
/* For System Memory > 128M, Allocate up to 192M of available RAM to DMA */
#define MAX_DMA_ADDRESS		(PAGE_OFFSET + (192 << 20))
#else
